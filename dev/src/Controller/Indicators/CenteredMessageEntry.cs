...
namespace Wof.Controller.Indicators
{
    public class CenteredMessageEntry : MessageEntry
    {
        ...
        protected void CenterMessage()
        {
            ...
            x = 0.15f; y = 0.40f - CharHeight;
        }

        public CenteredMessageEntry(Viewport viewport, uint time, string message, float charHeight, ColourValue colourTop, ColourValue colourBottom, bool blinking, bool permanent) : base(0, 0, time, message, charHeight, colourTop, colourBottom, blinking, permanent)
        {
        ...
        public CenteredMessageEntry(Viewport viewport, string message, bool blinking, bool permanent) : base(0, 0, message, blinking, permanent)
        {
            this.viewport = viewport;
            CenterMessage();
        }
