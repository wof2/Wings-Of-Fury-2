...
namespace Wof.Misc
{
    ...
    {
        /// <summary>
        /// Przelicza jednostki "modelu" na jednostki "view". Zwraca poprawne wartoœci dopiero po za³adowaniu poziomu
        /// </summary>
        /// <param name="logicPoint"></param>
        /// <returns></returns>
        public static Vector2 LogicToWorldUnits(PointD logicPoint)
        {
