...
{
    public class EndShipTileView : TileView, VertexAnimable
    {
        ...
        public override void initOnScene(SceneNode parentNode, int tileCMVIndex, int compositeModelTilesNumber)
        {
            ...
            if (LevelTile is EndShipTile)
            {
              
                installationNode =
                    parentNode.CreateChildSceneNode("EndShip" + tileID.ToString(), new Vector3(0, 0, -getRelativePosition(parentNode, LevelTile)));
