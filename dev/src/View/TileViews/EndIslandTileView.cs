...
{
    public class EndIslandTileView : TileView, VertexAnimable
    {
        protected List<AnimationState> animableElements;


        public EndIslandTileView(LevelTile levelTile, IFrameWork framework)
        ...
        public override void initOnScene(SceneNode parentNode, int tileCMVIndex, int compositeModelTilesNumber)
        {
            ...
            if (LevelTile is EndIslandTile)
            {
                installationNode =
                    parentNode.CreateChildSceneNode("End" + tileID.ToString(), new Vector3(0, 0, -getRelativePosition(parentNode, LevelTile)));
