...
namespace Wof.Languages
{
    ...
    public static class LanguageManager
    {
        ...
        /// <summary>
        /// Zwraca slownik z dosepnymi jezykami.
        /// Kluczem jest pelna nazwa jezyka w danym jezyku.
        /// Wartosc pod kluczem to kod jezyka.
        /// </summary>
        public static Dictionary<string, string> AvailableLanguages
        {
            get { return XmlLanguageManager.AvailableLanguages; }
        }

        /// <summary>
        /// Zwraca nazwe aktualnie wybranego jezyka.
        /// Jesli wystapi jakis blad. Jezyk na podstawie kodu nie zostanie
        /// znaleziony zwroci: String.Empty.
        /// </summary>
        public static string ActualLanguageName
        {
            get
            {
                foreach (KeyValuePair<string, string> lang in AvailableLanguages)
                    if (lang.Value.Equals(Settings.Default.Language))
                        return lang.Key;
                return String.Empty;
            }
        }
        ...
        /// <summary>
        /// Zwraca kod aktualanego jezyka.
        /// </summary>
        public static string ActualLanguageCode
        {
        ...
        /// Skroty jezykow.
        /// </summary>
        internal static class CultureType
        {
