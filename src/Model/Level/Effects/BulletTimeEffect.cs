...
namespace Wof.Model.Level.Effects
{
    ...
    /// </summary>
    public sealed class BulletTimeEffect : TimeEffect
    {
        #region Constructors
        ...
        public BulletTimeEffect(float startLevel, int loadInterval, int consumptionInterval)
            : base(startLevel, loadInterval, consumptionInterval)
        { }
        ...
        /// </summary>
        /// <param name="startLevel">Poziom poczatkowy efektu. Przedział: [0 - 1].</param>
        public BulletTimeEffect(float startLevel) : base(startLevel, 3000, 1000) { }

        #endregion

        #region Events

        public event LevelEffectChangeHandler LevelEffectChange;
        ...
        public override void Update(int time)
        {
            ...
            else if (_state == EffectState.Load)
            {
                if (interval > _loadInterval)
                {
                    oldValue = _effectLevel;
