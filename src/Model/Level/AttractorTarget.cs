...
{
	/// <summary>
	/// Description of Attractor.
	/// </summary>
	public class AttractorTarget : IAttractorTarget
	{
		protected Hashtable attractors;
		
		public AttractorTarget()
		{
		...
		public void RemoveAttaractor(string name)
		{
			if(attractors.ContainsKey(name)) attractors.Remove(name);
