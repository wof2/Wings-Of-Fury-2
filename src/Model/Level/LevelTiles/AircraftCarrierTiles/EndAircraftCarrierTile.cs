...
namespace Wof.Model.Level.LevelTiles.AircraftCarrierTiles
{
    ...
    /// </summary>
    public class EndAircraftCarrierTile : AircraftCarrierTile
    {
        ...
        public EndAircraftCarrierTile(float yBegin, float yEnd,float viewXShift, Quadrangle hitBound)
        ...
        {
            get { return Nodes.AircraftCarrierEnd; }
        }
