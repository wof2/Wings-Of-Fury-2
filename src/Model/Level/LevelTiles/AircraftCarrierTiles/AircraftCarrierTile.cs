...
namespace Wof.Model.Level.LevelTiles.AircraftCarrierTiles
{
    ...
    /// </summary>
    public abstract class AircraftCarrierTile : LevelTile
    {
        #region Public Consructor
        ...
        public AircraftCarrierTile(float yBegin, float yEnd, float viewXShift, Quadrangle hitBound)
