...
{
    /// <summary>
    /// Klasa implementujaca poczatek lotniskowca.
    /// </summary>
    public class BeginAircraftCarrierTile : AircraftCarrierTile
    {
        ...
        public BeginAircraftCarrierTile(float yBegin, float yEnd, float viewXShift, Quadrangle hitBound)
        ...
        public override int TileIndex
        {
            set
            {
                ...
                HitBound.Peaks[1].X += 2;
                HitBound.Peaks[0].X += 13;
            }
        }
    }
}