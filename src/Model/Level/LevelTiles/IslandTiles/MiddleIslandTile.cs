...
{
    /// <summary>
    /// Klasa implementujaca srodkowa czesc wyspy.
    /// </summary>
    public class MiddleIslandTile : IslandTile
    {
        ...
        public MiddleIslandTile(float yBegin, float yEnd, float viewXShift, Quadrangle hitBound, int type,
