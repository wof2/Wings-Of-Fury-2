...
{
    /// <summary>
    /// Klasa abstarkcyjna zarzadzajaca statkiem wroga.
    /// </summary>
    /// <author>Michal Ziober</author>
    [DebuggerDisplay("Count = {Count}")]
    public abstract class ShipManager : IRefsToLevel
    {
        ...
        protected TypeOfEnemyShip _typeOfEnemyShip;

        /// <summary>
        /// Stan statku
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected ShipState _shipState;

        /// <summary>
        /// Referencja do obiektu level.
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        protected Level _refToLevel;
        ...
        /// <summary>
        /// Zwraca typ wrogiego statku.
        /// </summary>
        public TypeOfEnemyShip TypeOfShip
        {
            get { return _typeOfEnemyShip; }
        }
        ...
        /// </summary>
        public ReadOnlyCollection<ShipTile> ShipTiles
        {
        ...
        public int Count
        {
            get { return _shipTiles.Count; }
        }

        /// <summary>
        /// Zwraca informacje czy do zatopienia statku potrzeba tylko
        /// jeszcze jednego trafienia.
        /// </summary>
        public abstract bool IsLastHit { get; }
        ...
        /// <exception cref="ArgumentOutOfRangeException">Jesli indeks statku jest mniejszy od zera
        /// lub wiekszy-rowny liczbie elementow statku.</exception>
        public ShipTile this[int i]
        {
            get { return _shipTiles[i]; }
        }
        ...
        #region IRefsToLevel Members

        /// <summary>
        /// Ustawia referencje do obiektu typu Level.
        /// </summary>
