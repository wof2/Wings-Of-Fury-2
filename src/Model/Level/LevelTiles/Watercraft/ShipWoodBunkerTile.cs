...
namespace Wof.Model.Level.LevelTiles.Watercraft
{
    ...
    /// </summary>
    public class ShipWoodBunkerTile : ShipBunkerTile
    {
        ...
        public ShipWoodBunkerTile(float yBegin, float yEnd, float viewXShift, Quadrangle hitBound, int soldierNum, int generalNum , int type,
