...
namespace Wof.Model.Level.XmlParser
{
    public class TilesNode
    {
        ...
        private List<Quadrangle> collisionRectangle;
        ...
        public Quadrangle HitRectangle
        {
            get { return hitRectangle; }
            set { hitRectangle = value; }
        }

        public Quadrangle Rectangle
        {
            get { return rectangle; }
            set { rectangle = value; }
        }

        public List<Quadrangle> CollisionRectangle
        {
