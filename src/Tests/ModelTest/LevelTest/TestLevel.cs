...
namespace Wof.Tests
{
    public class TestLevel
    {
        ...
        private static void TestSoldierMove()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                //soldier = new Soldier(rand.Next(5, 10));
        ...
        private static void TestToggleEngine()
        {
            ...
            if (levels != null && levels.Length > 0)
            {
                ...
                for (int i = 0; i < 103; i++)
                {
                    ...
                    Console.WriteLine("Licznik: {0}, Czy silnik wlaczony: {1}", i, level.UserPlane.IsEngineWorking);
                }
            }
        }
    }
