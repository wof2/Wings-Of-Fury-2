...
{
    public partial class RectanglesTestForm : Form
    {
        private Point[] tab;

        public RectanglesTestForm()
        {
            InitializeComponent();
        }

        private void RectanglesTest_Paint(object sender, PaintEventArgs e)
        {
            e.Graphics.FillPolygon(Brushes.Black, tab);
        }
