...
{
    /// <summary>
    /// Klasa miala byc wykorzystana do poruszania obiektami na scenie - rolê przej¹³ model
    /// </summary>
    public abstract class MoveNodeAnimation : NodeAnimation
    {
        ...
        public MoveNodeAnimation(SceneNode node, float animationDuration, Radian cycleLength, Vector3 axis, string name)
        ...
        public override void animate()
        {
            ...
            if (!startNewLoop)
            {
                move += maxMove*(amplitude - lastAmplitude);
            }
            else
            {
                // od poprzedniego stanu do konca animacji
                move += maxMove*(amplitudeAtEnd - lastAmplitude);
