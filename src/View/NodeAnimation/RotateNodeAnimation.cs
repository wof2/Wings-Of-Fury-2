...
namespace Wof.View.NodeAnimation
{
    ...
    /// </summary>
    public abstract class RotateNodeAnimation : NodeAnimation
    {
        protected Degree maxAngle;

        public Degree MaxAngle
        {
            get { return maxAngle; }
            set { maxAngle = value; }
        }
        ...
        protected bool returnToInitialOrientation = false;

        public bool ReturnToInitialOrientation
        {
            get { return returnToInitialOrientation; }
            set { returnToInitialOrientation = value; }
        }
        ...
        public override void animate()
        {
            ...
            if (!startNewLoop)
            {
                angle += new Radian(maxAngle*(amplitude - lastAmplitude));
            }
            else
            {
                // od poprzedniego stanu do konca animacji
                angle += new Radian(maxAngle*(amplitudeAtEnd - lastAmplitude));
