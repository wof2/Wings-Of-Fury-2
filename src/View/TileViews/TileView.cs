...
namespace Wof.View.TileViews
{
    public class TileView
    {
        ...
        //Node dla budynku -> bunkier / barak
        //oraz punkt odniesienia do dodawania drzewek/flagi/beczek
        protected SceneNode installationNode;

        public SceneNode InstallationNode
        {
            get { return installationNode; }
        }
