...
namespace Wof.Controller.Screens
{
    internal class PlanesScreen : AbstractScreen, BetaGUIListener
    {
        ...
        protected override void CreateGUI()
        {
            ...
            buttons[2] = guiWindow.createButton(p47img, matp47_2,
                                              "",
                                              cc, 2);
            buttons[2].mma = "";
                 

            buttons[3] = guiWindow.createButton(f4uimg, matf4u_2,
                                              "",
                                              cc, 3);
            buttons[3].mma = "";
            ...
            if (screenTime > C_RESPONSE_DELAY)
            {
                ...
                if (referer == buttons[0] || referer == buttons[2])
                {
                    ...
                    if (EngineConfig.IsEnhancedVersion)
                    {
                        ...
                        buttons[2].mmn = C_P47_2_ON;
                        buttons[3].mmn = C_F4U_2_OFF;

                        EngineConfig.CurrentPlayerPlaneType = PlaneType.P47;
                        EngineConfig.SaveEngineConfig();
                    }
                }else
                if (referer == buttons[1] || referer == buttons[3])
                {
                    PlayClickSound();
                    if (EngineConfig.IsEnhancedVersion)
                    {
                        ...
                        buttons[2].mmn = C_P47_2_OFF;
                        buttons[3].mmn = C_F4U_2_ON;
