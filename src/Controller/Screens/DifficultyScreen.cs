...
{
    internal class DifficultyScreen : AbstractOptionsScreen, BetaGUIListener
    {
        public DifficultyScreen(GameEventListener gameEventListener,
        ...
        {
            return LanguageResources.GetString(LanguageKey.ChooseDifficulty);
        }
