...
*/
    ...
    public class AbstractScreen : MenuScreen
    {
       ...
       // protected uint mousePosX, mousePosY;
        ...
        protected Boolean wasEscapeKeyPressed; 
        ...
        void HandleInput(Mouse inputMouse, Keyboard inputKeyboard, IList<JoyStick> inputJoysticks)
		{
			...
			if (mGui != null) {
				handleInputOnGui(inputMouse, inputKeyboard, inputJoysticks);				
			}
		...
		void handleInputOnGui(Mouse inputMouse, Keyboard inputKeyboard, IList<JoyStick> inputJoysticks)
		{
			...
			if (inputKeyboard.IsKeyDown(KeyCode.KC_1) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD1)) {
				mGui.injectKey("1", MousePos);
				KeyReceived("1");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_2) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD2)) {
				mGui.injectKey("2", MousePos);
				KeyReceived("2");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_3) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD3)) {
				mGui.injectKey("3", MousePos);
				KeyReceived("3");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_4) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD4)) {
				mGui.injectKey("4", MousePos);
				KeyReceived("4");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_5) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD5)) {
				mGui.injectKey("5", MousePos);
				KeyReceived("5");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_6) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD6)) {
				mGui.injectKey("6", MousePos);
				KeyReceived("6");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_7) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD7)) {
				mGui.injectKey("7", MousePos);
				KeyReceived("7");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_8) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD8)) {
				mGui.injectKey("8", MousePos);
				KeyReceived("8");
			}
			if (inputKeyboard.IsKeyDown(KeyCode.KC_9) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD9)) {
				mGui.injectKey("9", MousePos);
				KeyReceived("9");
			}
			
			if (inputKeyboard.IsKeyDown(KeyCode.KC_0) || inputKeyboard.IsKeyDown(KeyCode.KC_NUMPAD0)) {
			...
			if (skipHandlingGuiButtons) {
				...
				if (wereAllKeysReleased && wasEscapeKeyPressed) {
					KeyReceived("ESC");
