...
{
    internal class EnhancedVersionScreen : AbstractScreen, BetaGUIListener
    {
        ...
        /// Wiadomosc
        /// </summary>
        private readonly string message = /*String.Format()*/ LanguageResources.GetString(LanguageKey.EnhancedVersionDetails);
        ...
        public EnhancedVersionScreen(GameEventListener gameEventListener,
        ...
        protected override void CreateGUI()
        {
            ...
            guiWindow.createStaticText(new Vector4(5, 1.5f * GetTextVSpacing(), -10 + Viewport.ActualWidth / 2, 3 * GetTextVSpacing()), Wrap(message, 45));
        ...
        public void onButtonPress(Button referer)
        {
            if (screenTime > C_RESPONSE_DELAY)
            {
                ...
                {
                    PlayClickSound();
                    gameEventListener.GotoEnhancedVersionWebPage();
                }
            }
        }
